...
compliance!(add_block_duplicate_name_case_insensitive, "add-block-duplicate-name-case-insensitive.json");
compliance!(add_block_reserved_bracket, "add-block-reserved-bracket.json");
compliance!(add_block_percent_rejected, "add-block-percent-rejected.json");
compliance!(add_block_special_chars, "add-block-special-chars.json");
compliance!(add_block_stale_state, "add-block-stale-state.json");
compliance!(rename_block, "rename-block.json");
compliance!(rename_block_duplicate_name_case_insensitive, "rename-block-duplicate-name-case-insensitive.json");
compliance!(rename_block_reserved_bracket, "rename-block-reserved-bracket.json");
...
compliance!(append_section_duplicate_root, "append-section-duplicate-root.json");
